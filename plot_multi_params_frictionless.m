function rre = plot_multi_params_frictionless(path_to_data, idx, baseQR, drive_gains, varargin)
...
for set_idx = 1:n_sets
    ...
    for i = 1:length(vldtnTrjctry.t)
        ...
        regressor_combined = Ybi;
        params_combined = pi_b;
...
for joint = 1:6
    ...
    if options.plot_measured
        plot(vldtnTrjctry.t, tau_measured(joint,:), 'k-', ...
